...
6. Optionally replace the cover image. The one provided in the skeleton is just an all black 1400 x 2100 jpg. To change it just replace the cover in the EPUB/images directory. Keep the name as `cover.jpg` or manually edit `content.opf` if you know what you're doing
